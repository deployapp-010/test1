...
static_data = pd.read_csv(path+'static_data.csv') #
demo = pd.read_csv(path+'demographics.csv') #
demo_data = pd.read_csv(path+'demographics_data.csv') #
data = pd.read_csv(path+'metrics_master_table_new.csv') #
# data['event_type'] = data['event_type'].apply(lambda x: ' '.join(x.split('_')[1:]).title())
duration = pd.read_csv(path + 'duration_data.csv') #
tsne_data = pd.read_csv(path + 'tsne_data1.csv')
comorbidity_data = pd.read_csv(path+'comorbidities_data.csv') #
mapdata = pd.read_csv(path+'map_data.csv')

#------------------------------------------adding top menu-----------------------------------------------------------------------
over_theme = {'txc_inactive': 'White','menu_background':'gray','txc_active':'yellow'}
...
def Archetype_Journey():
    ...
    #    with col2:
            if cluster == 'Archetype 1':
                HtmlFile = open(path +"mg_dx_to_3l_cluster1.html", 'r', encoding='utf-8')
                st.markdown("""For Expanded View click here: <a href="http://localhost:8888/view/Desktop/dx23l_streamlit_v1/Data/Cluster1_extension.html" target = "_blank"> Archetype 1 </a>""", unsafe_allow_html=True)
                source_code = HtmlFile.read() 
                components.html(source_code, height = 200)

            elif cluster == 'Archetype 2': 
                HtmlFile = open(path +"mg_dx_to_3l_cluster2.html", 'r', encoding='utf-8')
                st.markdown("""For Expanded View click here:<a href="http://localhost:8888/view/Desktop/dx23l_streamlit_v1/Data/Cluster2_extension.html" target = "_blank"> Archetype 2 </a>""", unsafe_allow_html=True)
                source_code = HtmlFile.read() 
                components.html(source_code, height = 200) 

            elif cluster == 'Archetype 3': 
                HtmlFile = open(path +"mg_dx_to_3l_cluster3.html", 'r', encoding='utf-8')
                st.markdown("""For Expanded View click here:<a href="http://localhost:8888/view/Desktop/dx23l_streamlit_v1/Data/Cluster3_extension.html" target = "_blank"> Archetype 3 </a>""", unsafe_allow_html=True)
                source_code = HtmlFile.read() 
                components.html(source_code, height = 200) 

            elif cluster == 'Archetype 4': 
                HtmlFile = open(path + "/mg_dx_to_3l_cluster4.html", 'r', encoding='utf-8')
                st.markdown("""For Expanded View click here:<a href="http://localhost:8888/view/Desktop/dx23l_streamlit_v1/Data/Cluster4_extension.html" target = "_blank"> Archetype 4 </a>""", unsafe_allow_html=True)
                source_code = HtmlFile.read() 
                components.html(source_code, height = 200) 
    ...
    with st.expander("Event Frequency per Quarter by Archetype", expanded=False):
        ...
        with col1:
            ...
            HtmlFile = open(path +"dx_to_3l_events_html.html", 'r', encoding='utf-8')
            source_code = HtmlFile.read() 
        ...
        with col2:
            ...
            HtmlFile = open(path +"dx_to_3l_bitplot_html_overall_freq.html", 'r', encoding='utf-8')
            source_code = HtmlFile.read() 
            components.html(source_code, height = 800)
    ...
    with st.expander("Event Prevalence per Quarter by Archetype", expanded=False):
        ...
        with col2:
            ...
            HtmlFile = open(path +"dx_to_3l_bitplot_html_overall_prev.html", 'r', encoding='utf-8')
            source_code = HtmlFile.read() 
            components.html(source_code, height = 800)
...
#             components.html(source_code, height = 200)
    ...
    with col1:
        ...
        st.table(demo[demo['Demographics'].isin(['Age','Gender(Male)'])].reset_index(drop=True).style.format({"Archetype 1": "{:.1f}%", "Archetype 2": "{:.1f}%","Archetype 3": "{:.1f}%","Archetype 4": "{:.1f}%"}, subset=pd.IndexSlice[demo[demo['Demographics']=='Gender(Male)'].index, :]).format({"Archetype 1": "{:.1f}", "Archetype 2": "{:.1f}","Archetype 3": "{:.1f}","Archetype 4": "{:.1f}"}, subset=pd.IndexSlice[demo[demo['Demographics']=='Age'].index, :]).background_gradient(cmap=cmap_cf, axis=1))

        st.subheader('Comorbidities')
        st.table(demo[~(demo['Demographics'].isin(['Age','Gender(Male)','Gender(Female)']))].reset_index(drop=True).style.format({"Archetype 1": "{:.1f}%", "Archetype 2": "{:.1f}%","Archetype 3": "{:.1f}%","Archetype 4": "{:.1f}%"}).background_gradient(cmap=cmap_cf, axis=1))
    ...
    with col2:
        ...
        if d == 'Age':
            ...
            fig = px.bar(comorbidity_data, x='demographics', y=d, color='demographics', color_discrete_map = {'Archetype 1':'#92D0AA', 'Archetype 2':'#4B9ABB', 'Archetype 3':'#F2E394', 'Archetype 4':'#EC5923'},
    ...
    #         distribution = distribution.sort_values(by=str(sort) ,ascending=False).reset_index(drop=True)
            ...
            st.dataframe(distribution.style
                    .format({"Archetype 1": "{:.1f}", "Archetype 2": "{:.1f}","Archetype 3": "{:.1f}","Archetype 4": "{:.1f}", "Overall": "{:.1f}", "Standard Deviation": "{:.2f}"}).background_gradient(cmap=cmap_cf, axis=1, subset=distribution.filter(regex='Archetype').columns.tolist()), height=500, width=1500)
    ...
    #         distribution = distribution.sort_values(by=str(sort) ,ascending=False).reset_index(drop=True)
            ...
            st.dataframe(distribution.style.format({"Archetype 1": "{:.1f}", "Archetype 2": "{:.1f}","Archetype 3": "{:.1f}","Archetype 4": "{:.1f}", "Overall": "{:.1f}", "Standard Deviation": "{:.2f}"})
                    .background_gradient(cmap=cmap_cf, axis=1, subset=distribution.filter(regex='Archetype').columns.tolist()), height=500, width=1500)
    ...
    #         distribution = distribution.sort_values(by=str(sort) ,ascending=False).reset_index(drop=True)
            ...
            st.markdown(hide_table_row_index, unsafe_allow_html=True)
            st.dataframe(distribution.style.format({"Archetype 1": "{:.1f}", "Archetype 2": "{:.1f}","Archetype 3": "{:.1f}","Archetype 4": "{:.1f}", "Overall": "{:.1f}", "Standard Deviation": "{:.2f}"})
                    .background_gradient(cmap=cmap_cf, axis=1, subset=distribution.filter(regex='Cluster').columns.tolist()), height=500, width=1500)
