...
def Archetype_Journey():
    ...
    #    with col2:
            if cluster == 'Archetype 1':
                ...
                st.markdown("""For Expanded View click here: <a href="Cluster1_extension.html" target = "_blank"> Archetype 1 </a>""", unsafe_allow_html=True)
                ...
                st.markdown("""For Expanded View click here:<a href="Cluster2_extension.html" target = "_blank"> Archetype 2 </a>""", unsafe_allow_html=True)
                source_code = HtmlFile.read() 
                components.html(source_code, height = 200) 

            elif cluster == 'Archetype 3': 
                HtmlFile = open("mg_dx_to_3l_cluster3.html", 'r', encoding='utf-8')
                st.markdown("""For Expanded View click here:<a href="Cluster3_extension.html" target = "_blank"> Archetype 3 </a>""", unsafe_allow_html=True)
                source_code = HtmlFile.read() 
                components.html(source_code, height = 200) 

            elif cluster == 'Archetype 4': 
                HtmlFile = open("mg_dx_to_3l_cluster4.html", 'r', encoding='utf-8')
                st.markdown("""For Expanded View click here:<a href="Cluster4_extension.html" target = "_blank"> Archetype 4 </a>""", unsafe_allow_html=True)
                source_code = HtmlFile.read() 
                components.html(source_code, height = 200) 
